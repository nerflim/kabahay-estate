			...
			<div className='container mx-auto flex'>
				<div className='w-2/3 p-3 text-sm'>
					...
					<p className='mb-3'>
						...
						gravida gravida ut eu arcu. Ut augue odio, semper id nunc a, euismod cursus augue. Mauris a nisl et sem placerat ornare. Vivamus tristique
						convallis neque at blandit.
					</p>
					<p className='mb-3'>
						...
						sodales ut. Aenean at risus eu leo dictum ullamcorper. Praesent ac urna ac nisl congue condimentum eu vitae velit. Nunc molestie et ipsum
						eleifend tempus. Cras ullamcorper aliquam nisi eu tempor. Aliquam erat volutpat. Nullam vulputate dui finibus fermentum blandit. Ut a
						ligula dictum sapien cursus consequat porta quis ligula. Nulla mattis pretium dapibus. Quisque eu dignissim orci, in tristique augue.
					</p>
					<p className='mb-3'>
